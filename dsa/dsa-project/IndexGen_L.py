...
class ForwardIndex:
    ...
    def convertToWords(self, content):
        ...
        words = [lemmatizer.lemmatize(word.encode("ascii", errors="ignore").decode().strip('\',._+/\\!@#$?^()[]}{"').strip()) for word in words if word not in STOP_WORDS_SET]
    ...
    def writeForwardIndexToFile(self, forwardIndex):
        ...
        file_path = "Forward_index/" + "lemmatizedIndex" + str(self.__fileCounter) + ".json"
...
class InvertedIndex:
    ...
    def generateInvertedIndex(self, noFiles):
        ...
        for indexNo in range(noFiles):
            with open("Forward_Index/lemmatizedIndex"+str(indexNo)+".json", "r") as forwardIndexFile:
